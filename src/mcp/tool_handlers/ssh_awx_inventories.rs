//! SSH AWX Inventories Tool Handler
//!
//! Lists AWX inventories via REST API relayed through SSH.
...
/// Handler for the `ssh_awx_inventories` tool.
#[mcp_tool(name = "ssh_awx_inventories", group = "awx", annotation = "read_only")]
pub struct SshAwxInventoriesHandler;

impl Default for SshAwxInventoriesHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl SshAwxInventoriesHandler {
    ...
    const SCHEMA: &'static str = r#"{
        ...
        "properties": {
            ...
            "search": {
                "type": "string",
                "description": "Search filter for inventory names"
            },
            "timeout_seconds": {
                "type": "integer",
...
#[async_trait]
impl ToolHandler for SshAwxInventoriesHandler {
    fn name(&self) -> &'static str {
        "ssh_awx_inventories"
    }

    fn description(&self) -> &'static str {
        "List AWX inventories. Returns inventory names, IDs, host counts, and types."
    }
...
mod tests {
    ...
    fn test_args_deserialization() {
        ...
        let args: SshAwxInventoriesArgs = serde_json::from_value(json).unwrap();
        assert_eq!(args.page_size, Some(25));
        assert_eq!(args.search, Some("production".to_string()));
    ...
    fn test_args_debug() {
        ...
        assert!(debug_str.contains("SshAwxInventoriesArgs"));
    }
