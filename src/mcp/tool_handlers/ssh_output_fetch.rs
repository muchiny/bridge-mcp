...
impl SshOutputFetchHandler {
    const SCHEMA: &'static str = r#"{
        ...
        "properties": {
            ...
            "limit": {
                "type": "integer",
                "description": "Maximum characters to return in this page (default: server config max_output_chars, typically 40000). Use with offset to paginate: increment offset by the chars returned each call until has_more=false in the response header.",
                "minimum": 1
            }
        },
        "required": ["output_id"]
