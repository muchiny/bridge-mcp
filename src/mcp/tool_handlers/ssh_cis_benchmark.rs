...
mod tests {
    ...
    #[test]
    fn test_build_command_with_level_and_category() {
        let args: SshCisBenchmarkArgs = serde_json::from_value(json!({
            "host": "s",
            "level": 2,
            "category": "ssh"
        }))
