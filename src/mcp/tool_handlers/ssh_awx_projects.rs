//! SSH AWX Projects Tool Handler
//!
//! Lists AWX SCM projects via REST API relayed through SSH.
...
/// Arguments for `ssh_awx_projects` tool.
#[allow(dead_code)]
#[derive(Debug, Deserialize)]
struct SshAwxProjectsArgs {
    #[serde(default)]
...
/// Handler for the `ssh_awx_projects` tool.
#[mcp_tool(name = "ssh_awx_projects", group = "awx", annotation = "read_only")]
pub struct SshAwxProjectsHandler;

impl Default for SshAwxProjectsHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl SshAwxProjectsHandler {
    ...
    const SCHEMA: &'static str = r#"{
        ...
        "properties": {
            ...
            "search": {
                "type": "string",
                "description": "Search filter for project names"
            },
            "timeout_seconds": {
                "type": "integer",
...
#[async_trait]
impl ToolHandler for SshAwxProjectsHandler {
    fn name(&self) -> &'static str {
        "ssh_awx_projects"
    }

    fn description(&self) -> &'static str {
        "List AWX SCM projects. Returns project names, IDs, and sync status. Use \
         jq_filter to extract specific fields (e.g., '.results[] | {id,name,scm_type,scm_branch,status}')."
    }
    ...
    async fn execute(&self, args: Option<Value>, ctx: &ToolContext) -> Result<ToolCallResult> {
        ...
        let args: SshAwxProjectsArgs = serde_json::from_value(raw)
...
mod tests {
    ...
    async fn test_missing_arguments() {
        let handler = SshAwxProjectsHandler;
    ...
    fn test_schema() {
        let handler = SshAwxProjectsHandler;
        assert_eq!(handler.name(), "ssh_awx_projects");
        assert!(!handler.description().is_empty());

        let schema = handler.schema();
        assert_eq!(schema.name, "ssh_awx_projects");
    ...
    fn test_args_deserialization() {
        ...
        let args: SshAwxProjectsArgs = serde_json::from_value(json).unwrap();
    ...
    fn test_schema_optional_fields() {
        let schema_json: serde_json::Value =
            serde_json::from_str(SshAwxProjectsHandler.schema().input_schema).unwrap();
    ...
    fn test_args_debug() {
        ...
        assert!(debug_str.contains("SshAwxProjectsArgs"));
    }
